...
const Landing = () => (
  <section className="landing">
    ...
    <nav className="navbar fixed-bottom navbar-custom mt-5">
      <a className="portfolio-site" href="https://www.linkedin.com/in/ajay-dhage-88aab9164/" rel="noopener noreferrer" target="_blank">Ajay Dhage</a>
      <div className="github-site">
        <a className="github" href="https://github.com/githubajaydhage" rel="noopener noreferrer" target="_blank">GitHub</a>
      </div>
    </nav>
